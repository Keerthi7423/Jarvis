...
from config.settings import WS_BRIDGE_ENABLED, WS_BRIDGE_HOST, WS_BRIDGE_PORT
...
class WebSocketBridge:
    ...
    def __init__(self, host: str = WS_BRIDGE_HOST, port: int = WS_BRIDGE_PORT) -> None:
    ...
    async def _stats_loop(self) -> None:
        ...
        while True:
            try:
                ...
                sent_delta = max(0, int(net_now.bytes_sent - previous.bytes_sent)) if previous else 0
